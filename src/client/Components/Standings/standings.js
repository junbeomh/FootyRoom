                                    ...
                                    <TableRow hover key={row.id}>
                                        ...
                                        >
                                            <div>
                                                ...
                                                <b>
                                                    {" "}
                                                    {row.name.includes("Manchester")
                                                        ? row.name.replace("Manchester", "Man")
                                                        : row.name}{" "}
                                                </b>
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <div className="box">
                                                {row.forme
                                                    ...
                                                    .map(character =>
                                                        character == "W" ? (
                                                            <CheckCircleRoundedIcon style={winGameStyle}>
                                                                {" "}
                                                            </CheckCircleRoundedIcon>
                                                        ) : character == "D" ? (
                                                            <RemoveCircleRoundedIcon style={drawGameStyle}>
                                                                {" "}
                                                            </RemoveCircleRoundedIcon>
                                                        ) : character == "L" ? (
                                                            <CancelRoundedIcon style={looseGameStyle}>
                                                                {" "}
                                                            </CancelRoundedIcon>
                                                        ) : (
